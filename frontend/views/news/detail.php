    ...
    <div class="container" id="columns">
        ...
        <div class="row">
            <div class="column col-xs-12 col-sm-3" id="left_column">
                <?= \frontend\widgets\WidgetNewContent::widget(['project' => true]) ?>
                <!--./left silde-->
            </div>
            <!-- ./left colunm -->
            <!-- Center colunm-->
                                ...
                                <li class="post-item">
                                    <article class="entry">
                                        <div class="entry-thumb image-hover2">
                                            <a href="<?= Url::to(['news/detail', 'id' => $newR->id]) ?>">
                                                <img style="height: 160px" src="<?= $newR->getImageDisplayLink() ?>"
                                                     alt="<?= $newR->display_name ?>">
                                            </a>
                                        </div>
                                        <div class="entry-ci">
                                            <h3 class="entry-title"><a
                                                        href="<?= Url::to(['news/detail', 'id' => $newR->id]) ?>"><?= CUtils::substr($newR->display_name, 25) ?></a>
                                            </h3>
                                            <div class="entry-meta-data">
                                                <span class="date">
                                            ...
                                            <div class="entry-more">
                                                <a href="<?= Url::to(['news/detail', 'id' => $newR->id]) ?>">Chi
                                                    tiết</a>
                                            </div>
                                        </div>
                                    </article>
